    ...
    return ( 
        <div className="flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-10">
                <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Sign In</h2>
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center">
                            <input type="checkbox" className="rounded border-gray-100 text-indigo-600 focus:ring-indigo-200" />
                            <span className="ml-2 text-xl text-gray-600">Remember me</span>
                        </label>
                        <a href="#" className="text-xl text-indigo-600 hover:text-indigo-500">Forgot password?</a>
                    </div>
